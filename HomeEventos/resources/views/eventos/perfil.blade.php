                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-0">
                            ...
                            <ul class="list-inline mb-0 text-center text-sm-start mt-3 mt-sm-0">
                                ...
                                <li class="list-inline-item"><i class="bi bi-calendar2-plus me-1"></i> Joined on Nov
                                    26, 2019</li>
                            </ul>
                        </div>
                        <!-- Card body END -->
                        <div class="card-footer mt-3 pt-2 pb-0">
                            ...
                            <ul
                                ...
                                <li class="nav-item"> <a class="nav-link" href="my-profile-about.html"> About </a>
                                </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-sm-flex align-items-center justify-content-between border-0 pb-0">
                            ...
                            <a class="btn btn-primary-soft btn-sm" href="#"> <i
                                    class="fa-solid fa-plus pe-1"></i> Create events</a>
                        </div>
                        <!-- Card header END -->
                        <!-- Card body START -->
                        <div class="card-body">
