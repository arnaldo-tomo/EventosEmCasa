                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0 pb-0">
                                    ...
                                    @if (session('senhaactual'))
                                        <div class="alert alert-danger" role="alert">{{ ssesion('senhaactual') }}
                                        </div>
                                    @endif
                                    <!-- Title START-->
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('PasswordUpdate') }}" class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('senhaactual') }}" name="senhaactual"
                                                    placeholder="">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <input
                                                        class="form-control fakepassword  @if (session('password_confirmation')) is-invalid @endif"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text"
                                                    class="form-control
                                                    @if (session('password_confirmation')) is-invalid @endif"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <p class="mb-0">Tried law yet style child. The bore of true of no be deal.
                                            Frequently sufficient to be unaffected. The furnished she concluded
                                            depending
                                                            ...
                                                            <a href="#!"
                                                                ...
                                                                <span>
                                                                    <span class="mb-0 h6 d-block">Email
                                                                        notifications</span>
                                                                    <small class="small mb-0 text-secondary">As
                                                                        hastened oh
                            ...
                            <div class="tab-pane fade" id="nav-setting-tab-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <p class="mb-0">See information about your account, download an archive of
                                            your
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li
                                                ...
                                                <div class="me-md-3">
                                                    ...
                                                    <p class="small mb-0">Unaffected occasional thoroughly. Adieus it
                                                        no
                            ...
                            <div class="tab-pane fade" id="nav-setting-tab-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <p class="mb-0">He moonlights difficult engrossed it, sportsmen. Interested
                                            has
                                            all Devonshire difficulty gay assistance joy. Unaffected at ye of compliment
                                            alteration to.</p>
                                    </div>
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="me-2">
                                                                    ...
                                                                    <p class="small">Your personal information is safe
                                                                        with our marketing partners unless you respond
                                                                        to
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-group list-group-flush">
                                                            ...
                                                            <li
                                                                class="list-group-item d-sm-flex justify-content-between align-items-center px-0 py-1 border-0">
                                                                <div class="me-2">
                                                                    <p class="mb-0">Allow people to search by your
                                                                        email
                                                                        address? </p>
                                                                </div>
                                                                <div class="form-check form-switch">
                            ...
                            <div class="tab-pane fade" id="nav-setting-tab-5">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <p class="mb-0">As young ye hopes no he place means. Partiality diminution
                                            gay
                                            yet entreaties admiration. In mention perhaps attempt pointed suppose.
                                            Unknown
