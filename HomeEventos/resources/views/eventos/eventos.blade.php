...
<!-- Mirrored from social.webestica.com/event-details-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 08:44:13 GMT -->
                ...
                <div class="py-5">
                    <div class="row position-relative">
                        <div class="col-xl-8 col-lg-10 mx-auto pt-sm-5 text-center">
                            ...
                            <!-- Title -->
                            <h1 class="text-white">The learning conference</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="mt-4">
                                <ul class="list-unstyled mb-4">
                                    <li class="d-flex justify-content-between mb-3"> <strong class="w-150px">Show Date
                                            & time:</strong> <span class="text-end"> 12 December, 8:20PM </span></li>
                                    <li class="d-flex justify-content-between mb-3"> <strong class="w-150px">Ticket
                                            Price:</strong> <span class="text-end"> $210.00 </span></li>
                                    <li class="d-flex justify-content-between mb-3"> <strong class="w-150px">Entry
                                            fees:</strong> <span class="text-end"> $1 per ticket </span></li>
                                    <li class="d-flex justify-content-between mb-3"> <strong
                                            class="w-150px">Address:</strong> <span class="text-end"> 750 Sing Sing
                                            Rd, Horseheads, NY, 14845 </span></li>
                                </ul>
                    ...
                    <div class="col-lg-8">
                        <div class="card card-body">
                            <!-- Overview -->
                            <h4>Overview </h4>
                            <p>Appear third them gathered created divided all years spirit saying for great saying made
                                had fly dry that darkness meat unto Thing spirit his fifth likeness divided also seed
                                lesser image dominion sea fifth i god so saw open great Living.</p>
                            <img class="img-fluid mb-3" src="assets/images/events/06.jpg" alt="">
                            <h6>Female saying may multiply upon life</h6>
                            <p>To don't may give void forth created fruitful bearing creepeth fish god night you're
                                brought creeping so you'll herb place blessed creepeth beast Green face fruitful stars
                                man multiply Creepeth upon over darkness There dominion day from man doesn't won't us
                                two fish a female saying may multiply upon life.</p>
                                ...
                                <div class="accordion accordion-icon" id="accordionschedules">
                                    ...
                                    <div class="accordion-item mb-3">
                                        <div class="accordion-header" id="scheduleOne">
                                            <button class="accordion-button pe-5 flex-wrap mb-0" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#schedulecollapseOne"
                                                aria-expanded="true" aria-controls="schedulecollapseOne">
                                        ...
                                        <!-- Accordion info -->
                                        <div id="schedulecollapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="scheduleOne" data-bs-parent="#accordionschedules">
                                            <div class="accordion-body">
                                                <p>Particular way thoroughly unaffected projection favorable Mrs can be
                                                    projecting own. Thirty it matter enable become admire in giving. See
                                                    resolved goodness felicity shy civility domestic had but. Drawings
                                                    offended yet answered Jennings perceive laughing six did far. </p>
                                                <div class="row g-4">
                                                    <div class="col-12">
                                    ...
                                    <!-- Accordion item -->
                                    <div class="accordion-item mb-3">
                                        <div class="accordion-header" id="scheduleTwo">
                                            <button class="accordion-button pe-5 flex-wrap mb-0 collapsed"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#schedulecollapseTwo" aria-expanded="false"
                                                aria-controls="schedulecollapseTwo">
                                                <span class="me-2">February 05, 2023</span>
                                                <span class="me-2">07:00 </span>
                                                <strong>Making it over 2000 years</strong>
                                            </button>
                                        </div>
                                        <!-- Accordion info -->
                                        <div id="schedulecollapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="scheduleTwo" data-bs-parent="#accordionschedules">
                                            <div class="accordion-body">
                                                <p>Particular way thoroughly unaffected projection favorable Mrs can be
                                                    projecting own. Thirty it matter enable become admire in giving. See
                                                    resolved goodness felicity shy civility domestic had but. Drawings
                                    ...
                                    <!-- Accordion item -->
                                    <div class="accordion-item mb-3">
                                        <div class="accordion-header" id="scheduleThree">
                                            <button class="accordion-button pe-5 flex-wrap mb-0 collapsed"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#schedulecollapseThree" aria-expanded="false"
                                                aria-controls="schedulecollapseThree">
                                                <span class="me-2">December 15, 2022</span>
                                                <span class="me-2">8:00PM </span>
                                                <strong>The furnished she concluded depending </strong>
                                            </button>
                                        </div>
                                        <!-- Accordion info -->
                                        <div id="schedulecollapseThree" class="accordion-collapse collapse"
                                            aria-labelledby="scheduleThree" data-bs-parent="#accordionschedules">
                                            <div class="accordion-body">
                                                <p>Particular way thoroughly unaffected projection favorable Mrs can be
                                                    projecting own. Thirty it matter enable become admire in giving. See
                                                    resolved goodness felicity shy civility domestic had but. Drawings
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-4 col-lg-3">
                                                        ...
                                                        <div class="card card-body text-center">
                                                            <div class="avatar avatar-lg mx-auto mb-3">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/images/avatar/06.jpg" alt="">
                                                            </div>
                                                            <!-- Host name -->
                                                            <div>
                                                                <h6 class="mb-0">Bryan Knight</h6>
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="scheduleFour">
                                            <button class="accordion-button pe-5 flex-wrap mb-0 collapsed"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#schedulecollapseFour" aria-expanded="false"
                                                aria-controls="schedulecollapseFour">
                                                <span class="me-2">March 17, 2022</span>
                                                <span class="me-2">2:00PM </span>
                                                <strong>Particular way thoroughly</strong>
                                            </button>
                                        </div>
                                        <!-- Accordion info -->
                                        <div id="schedulecollapseFour" class="accordion-collapse collapse"
                                            aria-labelledby="scheduleFour" data-bs-parent="#accordionschedules">
                                            <div class="accordion-body">
                                                <p>Particular way thoroughly unaffected projection favorable Mrs can be
                                                    projecting own. Thirty it matter enable become admire in giving. See
                                                    resolved goodness felicity shy civility domestic had but. Drawings
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-4 col-lg-3">
                                                        ...
                                                        <div class="card card-body text-center">
                                                            <div class="avatar avatar-lg mx-auto mb-3">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="assets/images/avatar/08.jpg" alt="">
                                                            </div>
                                                            <!-- Host name -->
                                                            <div>
                                                                <h6 class="mb-0">Bryan Knight</h6>
                                ...
                                <div class="accordion accordion-icon" id="accordionfaq">
                                    ...
                                    <div class="accordion-item mb-3">
                                        <div class="accordion-header" id="faqOne">
                                            <button class="accordion-button pe-5 flex-wrap fw-bold" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#faqcollapseOne"
                                                aria-expanded="true" aria-controls="faqcollapseOne">
                                                How does it work? You can buy as much or as little as you like!
                                            </button>
                                        </div>
                                        <div id="faqcollapseOne" class="accordion-collapse collapse show"
                                            aria-labelledby="faqOne" data-bs-parent="#accordionfaq">
                                            <div class="accordion-body">
                                                <p>For who thoroughly her boy estimating conviction. Removed demands
                                                    expense account in outward tedious do.</p>
                                                <p class="mb-0">Particular way thoroughly unaffected projection
                                                    favorable Mrs can be projecting own. Thirty it matter enable become
                                                    admire in giving. See resolved goodness felicity shy civility
                                    ...
                                    <div class="accordion-item mb-3">
                                        <div class="accordion-header" id="faqTwo">
                                            <button class="accordion-button pe-5 flex-wrap fw-bold collapsed"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#faqcollapseTwo" aria-expanded="false"
                                                aria-controls="faqcollapseTwo">
                                                Do I need to book an early slot to find the best clothes?
                                            </button>
                                        </div>
                                        <div id="faqcollapseTwo" class="accordion-collapse collapse"
                                            aria-labelledby="faqTwo" data-bs-parent="#accordionfaq">
                                            <div class="accordion-body">
                                                <p>The furnished she concluded depending procuring concealed.</p>
                                                <p class="mb-0">Rooms oh fully taken by worse do. Points afraid but
                                                    may end law lasted. Was out laughter raptures returned outweigh.
                                                    Luckily cheered colonel I do we attack highest enabled. Tried law
                                                    yet style child. The bore of true of no be deal. Frequently
                                                    sufficient to be unaffected. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Faq accordion Item -->
                                    <div class="accordion-item mb-3">
                                        ...
                                        <div id="faqcollapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>Match way these she avoids seeing death. She who drift their fat off.
                                                </p>
                                                <p class="mb-0">Speedily say has suitable disposal add boy. On forth
                                                    doubt miles of child. Exercise joy man children rejoiced. Yet
