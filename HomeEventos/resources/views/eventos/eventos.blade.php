...
<!-- Mirrored from social.webestica.com/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 08:44:07 GMT -->

<head>
    <title>Eventos - Network, Community and Event Theme</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ URL::asset('/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}">

    <!-- Theme CSS -->
    <link id="style-switch" rel="stylesheet" type="{{ URL::asset('/text/css" href="assets/css/style.css') }}">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a class="navbar-brand" href="index-2.html">
                    <img class="light-mode-item navbar-brand-item" src="{{ URL::asset('assets/images/logo.svg') }}"
                        alt="logo">
                    <img class="dark-mode-item navbar-brand-item" src="{{ URL::asset('assets/images/logo.svg') }}"
                        alt="logo">
                </a>
                <!-- Logo END -->
            ...
            <div class="row g-4">
                ...
                <div class="col-md-8 col-lg-9 vstack gap-4">
                    ...
                    <div class="card card-body card-overlay-bottom border-0"
                        style="background-image:url(assets/images/events/06.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
                        <!-- Card body START -->
                        ...
                        <div
                            ...
                            <div class="col-lg-9">
                                <h1 class="h3 mb-1 text-white">The learning conference </h1>
                                <a class="text-white" href="https://themes.getbootstrap.com/store/webestica"
                                    target="_blank">https://themes.getbootstrap.com/store/webestica</a>
                            </div>
                            <!-- Button -->
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <p class="mb-0">He moonlights difficult engrossed it, sportsmen. Interested has all
                                    ...
                                    to. Place voice no arises along to. Parlors waiting so against me no.</p>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <p class="mb-0 small"> <strong> #2 of 3506</strong> Events in Photography & Prewedding
                                </p>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <!-- Interested -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-sm-flex flex-wrap align-items-center mb-3">
                                        ...
                                        <div class="avatar avatar-md">
                                            <img class="avatar-img rounded-circle border border-white border-3"
                                                src="assets/images/logo/01.svg" alt="">
                                        </div>
                                        <!-- info -->
                                    ...
                                    <div class="d-sm-flex flex-wrap align-items-center mb-3">
                                        ...
                                        <div class="avatar avatar-md">
                                            <img class="avatar-img rounded-circle border border-white border-3"
                                                src="assets/images/logo/02.svg" alt="">
                                        </div>
                                        <!-- info -->
                                        <div class="ms-sm-2 my-2 my-sm-0">
                                    ...
                                    <div class="d-sm-flex flex-wrap align-items-center mb-3">
                                        ...
                                        <div class="avatar avatar-md">
                                            <img class="avatar-img rounded-circle border border-white border-3"
                                                src="assets/images/logo/06.svg" alt="">
                                        </div>
                                        <!-- info -->
                                        <div class="ms-sm-2 my-2 my-sm-0">
                                    ...
                                    <div class="d-sm-flex flex-wrap align-items-center">
                                        ...
                                        <div class="avatar avatar-md">
                                            <img class="avatar-img rounded-circle border border-white border-3"
                                                src="assets/images/logo/04.svg" alt="">
                                        </div>
                                        <!-- info -->
                                        <div class="ms-sm-2 my-2 my-sm-0">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <p class="small"> <i class="bi bi-geo-alt pe-1"></i>750 Sing Sing Rd, Horseheads,
                                        NY, 14845 </p>
                                    <!-- Button modal -->
                                </div>
                                <!-- Card body START -->
